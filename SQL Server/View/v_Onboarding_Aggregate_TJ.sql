...
/****** Object:  View [dbo].[v_Onboarding_Aggregate_TJ]    Script Date: 08/26/2014 15:12:35 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[v_Onboarding_Aggregate_TJ]
AS
    ...
    FROM    ( SELECT    CONVERT(VARCHAR(10) , ec.createdate , 101) AS DateLink ,
            ...
            --*** Drop Accepted (6) and Inactive (7) premise status.
              ...
              WHERE     es.enrollstatusid NOT IN ( 25 )
            ) ONBRD
