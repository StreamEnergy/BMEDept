...
/****** Object:  View [dbo].[v_NE_Billing_Transaction]    Script Date: 08/26/2014 15:11:23 ******/
SET ANSI_NULLS ON
GO
...
3/10/2014				Steve Nelson						 Update:  ADD Invoice ID
7/17/2014				Steve NElson						Update:  CHANGE ServiceActionCode TO ServiceAction
...
CREATE VIEW [dbo].[v_NE_Billing_Transaction]
AS
    SELECT
  DISTINCT  CustomerTransactionRequest.CustID ,
            ...
            CustomerTransactionRequest.ServiceAction AS [867_ServiceAction] ,
            ...
            Invoice.InvoiceID AS [810_InvID] ,
    ...
    SELECT  CustomerTransactionRequest.CustID ,
            ...
            CustomerTransactionRequest.StatusCode AS [814_Status] ,
