...
/****** Object:  View [dbo].[v_Contract_EDF]    Script Date: 08/26/2014 13:30:44 ******/
SET ANSI_NULLS ON
GO
...
Date					Author								Description
						Preetha Sridhar						Source view for generating the ELECTRICTITY flat file that is sent
						Eric McCormick						via FTP to EDF.
															08.12:  Production source for EDF file generation.
...
CREATE VIEW [dbo].[v_Contract_EDF]
AS
    SELECT DISTINCT
            L.LDCID ,
