...
/****** Object:  View [dbo].[v_EAGLE_Free_Gas_100]    Script Date: 08/26/2014 13:50:17 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[v_EAGLE_Free_Gas_100]
AS
    SELECT  'Free Gas 100' AS Program_Name ,
    ...
    WHERE   tc.[App Date] > '2013-09-28'
            ...
            AND td.Type = 'D' 
-- AND		td.[IA Number]					NOT IN (SELECT distinct [IA_Number] from dbo.v_EAGLE_Free_Gas_100_Ignition)
