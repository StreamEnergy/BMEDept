...
/****** Object:  View [dbo].[v_ISTA_Customers_HUD]    Script Date: 08/26/2014 15:08:23 ******/
SET ANSI_NULLS ON
GO
...
Date					Author								Description
						...
						& Eric McCormick					various customer related reports used by the wholesale group.  
															...
															Development Notes:	
															Same information contained in the v_ISTA_Customer view with the
															inclusion of historical usage data (HUD).
															HUD consists of Market HUD for new customers (v_ISTA_Market_HUD_Summary) 
															and Stream HUD for existing customers (v_ISTA_Stream_HUD_Summary)
															When complete and tested this view will replace v_ISTA_Customers.
...
CREATE VIEW [dbo].[v_ISTA_Customers_HUD]
AS
    SELECT DISTINCT
            L.LDCID ,
            ...
            L.DUNS ,
            A.Zip ,
            MHUD.DailyAvgConsumption AS DailyAvgMHUD ,
            SHUD.DailyAvgConsumption AS DailyAvgSHUD
    ...
    LEFT JOIN StreamInternal.dbo.v_ISTA_Market_HUD_Summary MHUD ON P.PremNo = MHUD.PremNo
    LEFT JOIN StreamInternal.dbo.v_ISTA_Stream_HUD_Summary SHUD ON MR.MeterID = SHUD.MeterID
