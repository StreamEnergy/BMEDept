...
/****** Object:  View [dbo].[v_EAGLE_Free_Electricity_100_Ignition]    Script Date: 08/26/2014 13:49:47 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[v_EAGLE_Free_Electricity_100_Ignition]
AS
    SELECT  'Free Electricity 100 Ignition' AS Program_Name ,
    ...
    WHERE   tc.[App Date] > '2013-09-28'
            ...
            AND td.Type = 'D' 
-- AND		td.[IA Number]					NOT IN (SELECT distinct [IA_Number] from dbo.v_EAGLE_Free_Electricity_100)
